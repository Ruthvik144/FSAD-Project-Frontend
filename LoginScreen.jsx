...
const LoginScreen = ({ onLogin }) => {
  ...
  const [isRegistering, setIsRegistering] = useState(window.location.pathname === '/signup');
              ...
              <div className="flex gap-4">
                 ...
                 <div className="flex-1">
                    ...
                    <select 
                      ...
                      className="w-full px-4 py-3 border border-gray-300 rounded-xl bg-white focus:outline-none focus:border-indigo-500 text-gray-700"
                    >
